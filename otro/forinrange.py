...
for i in range(2, n+1, 2): #obligatorio es el primero que va hacer si o si, y es el limite inferior y el segundo el limite superior (los numeros que va avanzar)
